...
public class PetShop{
    ...
    public PetShop(LinkedList<Atendimento> atendimentoList) {
    	...
    	switch(escolha) {
    		case 1:
    			...
    			System.out.println(
    					...
    					Servicos.PROMOCAO.opcao + " - " + Servicos.PROMOCAO + "\n"
    					);
    			
    			opcao = teclado.nextInt();
    			
    			criarAtendimento(opcao);
    ...
    public void criarAtendimento(int opcao) {
    	...
    	System.out.println("Seu animal é um 1-cachorro ou 2-gato?");
      	...
      	System.out.println("Digite a data de nascimento do seu animal no formato yyyy-mm-dd");
      	resposta = teclado.next();
      	animal.setDataNascimento(LocalDate.parse(resposta));
    ...
    public Atendimento finalizarAtendimento() {
    	Atendimento finalizarAtendimento = atendimentoList.getFirst();
    	System.out.print("Você nos deve R$ %.2f" + finalizarAtendimento.getPreco() + "\n");
    	System.out.println("Obrigado e volte sempre!");
    ...
    public void setAtendimentoList(LinkedList<Atendimento> atendimentoList) {
        this.atendimentoList = atendimentoList;
    }
}